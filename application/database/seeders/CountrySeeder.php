...
class CountrySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $countries = array(
            ...
            array('code' => 'US', 'name' => 'Afghanistan'),
        ...
        for ($i = 0; $i < $countries_count; $i++) {
            $countries[$i]['iso'] = $countries[$i]['code'];
            $countries[$i]['nice_name'] = $countries[$i]['name'];
            $countries[$i]['phone_code'] = '+00';
            $countries[$i]['created_at'] = Carbon::now()->format('Y-m-d H:i:s');
        }
