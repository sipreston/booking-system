...
# Test script to allow variables, for easeri future use.
...
# Xdebug
cp application/vagrant/php/mods-available/xdebug.ini /etc/php/{$PHP_VERSION}/mods-available/xdebug.ini
